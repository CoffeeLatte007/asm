 ...
 * @version $Id: asm.util.DesensitizeUtil.java, v 0.1 2018-04-29 上午12:52 @lizhao $$
 */
public class DesensitizeUtil {
    ...
    public static String identificationNum(String id) {
        ...
        return StringUtils.left(id, 3).concat(
            StringUtils.removeStart(StringUtils.leftPad(StringUtils.right(id, 2), StringUtils.length(id), "*"), "***"));
    }
